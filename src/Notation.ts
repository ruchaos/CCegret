class Notation {
    ...
    public addNotation(notation:any):void{
        var note={
            currentPlayer:notation.currentPlayer,
            lastMove:notation.lastMove,
            currentStats:notation.currentStats,
            currentPostions:notation.currentPostions
        };
        this.NotationHistory.push(note);
        
    }

    public getNotation(step:number):any{
        var note={
            currentPlayer:this.NotationHistory[step].currentPlayer,
            lastMove:this.NotationHistory[step].lastMove,
            currentStats:this.NotationHistory[step].currentStats,
            currentPostions:this.NotationHistory[step].currentPostions
        }
        return note;
    }
    ...
    public lastMove:any={};
    public currentStats:any={restrict:""};
    public NotationHistory:any[]=[];   
}