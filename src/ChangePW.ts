class ChangePW extends eui.Component implements  eui.UIComponent {
	public constructor() {
		super();
		this.addEventListener(eui.UIEvent.COMPLETE,this.uiCompHandler,this);
		this.skinName="resource/custom_skins/ChangePW.exml";
	}
	...
	private changePWSuccess(usernamesuccess:string):void{
		...
		var LobbyLogout:LOBBYEVENT=new LOBBYEVENT(LOBBYEVENT.LOGOUT);
