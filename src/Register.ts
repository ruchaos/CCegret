class Register extends eui.Component implements  eui.UIComponent {
	public constructor() {
		...
		this.skinName="resource/custom_skins/Register.exml";
	}
	...
	private RegisterSuccess(usernamesuccess:string):void{
	...
	private RegisterFailed(error):void{		
		if(error.username){
	...
	// private UNapproved:boolean=false;
	// private PWapproved:boolean=false;
	// private RPapproved:boolean=false;
	// private CNapproved:boolean=false;
//页面UI定义
