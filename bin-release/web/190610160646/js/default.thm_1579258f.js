window.skins={};
	...
	function ChangePWSkin() {
		_super.call(this);
		this.skinParts = ["curtain","newPW","lhintNP","repeatPW","lhintRP","clueName","lhintCN","title","close","submit"];
		
		this.height = 1280;
		this.width = 720;
		this.elementsContent = [this.curtain_i(),this._Image1_i(),this._Rect1_i(),this.newPW_i(),this.lhintNP_i(),this._Rect2_i(),this.repeatPW_i(),this.lhintRP_i(),this._Rect3_i(),this.clueName_i(),this.lhintCN_i(),this.title_i(),this.close_i(),this.submit_i()];
	}
	...
	function CreateSkin() {
		_super.call(this);
		this.skinParts = ["curtain","title","close","submit","typehint","timehint","type1","time1","time2","time3","type2","type3"];
		
		this.height = 1280;
		this.width = 720;
		this.elementsContent = [this.curtain_i(),this._Image1_i(),this.title_i(),this.close_i(),this.submit_i(),this.typehint_i(),this.timehint_i(),this.type1_i(),this.time1_i(),this.time2_i(),this.time3_i(),this.type2_i(),this.type3_i()];
	}
	...
	function GameItemSkin() {
		...
		this.height = 132;
		this.width = 671;
		this.elementsContent = [this._Button1_i(),this._Label1_i(),this._Label2_i(),this._Label3_i(),this._Label4_i()];
		
		eui.Binding.$bindProperties(this, ["hostComponent.data.hostName"],[0],this._Label1,"text");
		eui.Binding.$bindProperties(this, ["hostComponent.data.gameType"],[0],this._Label2,"text");
		eui.Binding.$bindProperties(this, ["hostComponent.data.gameTime"],[0],this._Label3,"text");
		eui.Binding.$bindProperties(this, ["hostComponent.data.gameDate"],[0],this._Label4,"text");
	}
	...
	function LoginSkin() {
		_super.call(this);
		this.skinParts = ["curtain","userName","lhintUN","password","lhintPW","title","close","submit","toRegister","toChangePW"];
		
		this.height = 1280;
		this.width = 720;
		this.elementsContent = [this.curtain_i(),this._Image1_i(),this._Rect1_i(),this.userName_i(),this.lhintUN_i(),this._Rect2_i(),this.password_i(),this.lhintPW_i(),this.title_i(),this.close_i(),this.submit_i(),this.toRegister_i(),this.toChangePW_i()];
	}
	...
	function PersonSkin() {
		_super.call(this);
		this.skinParts = ["curtain","title","close","submit","games","tips","toChangePW"];
		
		this.height = 1280;
		this.width = 720;
		this.elementsContent = [this.curtain_i(),this._Image1_i(),this.title_i(),this.close_i(),this.submit_i(),this.games_i(),this.tips_i(),this.toChangePW_i()];
	}
	...
	function RegisterSkin() {
		_super.call(this);
		this.skinParts = ["curtain","userName","lhintUN","password","lhintPW","repeatPW","lhintRP","clueName","lhintCN","title","close","submit"];
		
		this.height = 1280;
		this.width = 720;
		this.elementsContent = [this.curtain_i(),this._Image1_i(),this._Rect1_i(),this.userName_i(),this.lhintUN_i(),this._Rect2_i(),this.password_i(),this.lhintPW_i(),this._Rect3_i(),this.repeatPW_i(),this.lhintRP_i(),this._Rect4_i(),this.clueName_i(),this.lhintCN_i(),this.title_i(),this.close_i(),this.submit_i()];
	}
